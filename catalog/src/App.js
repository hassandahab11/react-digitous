...
import "./components/listeoffilms";
import Films from "./components/listeoffilms";
  ...
  render() {
    return (
      <BrowserRouter>
        ...
        {this.movies.map(function (x) {
          return <Films title={x.title} director={x.director} stars={x.stars} image={x.image} description={x.description} />;
        })}
      </BrowserRouter>
